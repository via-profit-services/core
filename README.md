...
![version-badge](https://img.shields.io/static/v1?label=version&message=0.30.9&color=blueviolet)
...
Список версий см. [здесь](https://github.com/via-profit-services/core/releases)
...
Для получения токена необходимо воспользоваться сервером аутентификации (см. [Аутентификация](#authentication))
