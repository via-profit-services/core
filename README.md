...
![version-badge](https://img.shields.io/static/v1?label=version&message=0.30.4&color=blueviolet)
...
```bash
yarn add ssh://git@gitlab.com:via-profit-services/core.git#semver:^0.30.4
```
